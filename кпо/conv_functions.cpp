 ...
 */
static unsigned int unsigned_integer_data_type_conversion(BYTE* x, size_t byte_lenght, size_t bit_lenght, bool order) {
	if (order) {
 ...
 */
static int signed_integer_data_type_conversion(BYTE* x, size_t byte_lenght, size_t bit_lenght, bool order, int negative_coding) {
 ...
 */
static double fixed_point_data_type_conversion(BYTE* x, size_t byte_lenght, size_t bit_lenght, bool order, int negative_coding, double low_order_price) {
 ...
 * @return double выход - преобразованное вещественное число
 */
static double float_point_data_type_conversion(BYTE* x, size_t byte_lenght, size_t bit_lenght, size_t exponent_length, int base) {
